...
>圖上的顏色代表接線，以紅黑線或杜邦線為主，若是用紅黑線，需將外層的殼先剪開，在進行接線。杜邦線直接使用即可。還是以當下狀況決定使用哪種線材
...
| 幫浦 | L298N 腳位（第一台） | L298N 腳位（第二台） | 圖上接線顏色（杜邦線） | 樹莓派實體腳位 | GPIO |
|------|--------------------|--------------------|----------------------|---------------|------|
...
| 幫浦編號 | 幫浦正負極 | 圖上接線顏色(杜邦線) | L298N 腳位（第一台） | L298N 腳位（第二台） |
|---------|------------|----------------|----------------------|----------------------|
| 第一顆幫浦 | 紅線 | 橘色 | OUT1 | |
| | 黑線 | 藍色 | OUT2 | |
| 第二顆幫浦 | 紅線 | 粉色 | OUT3 | |
...
#### 當玩家進入遊戲選擇了其中一個模式，輸入名字，才能夠進入次模式。
